...
type CreateRoutineExerciseInputResolver interface {
	Sets(ctx context.Context, obj *ent.CreateRoutineExerciseInput, data map[string]interface{}) error
}
type CreateWorkoutLogInputResolver interface {
	Sets(ctx context.Context, obj *ent.CreateWorkoutLogInput, data map[string]interface{}) error
}
type UpdateRoutineExerciseInputResolver interface {
	Sets(ctx context.Context, obj *ent.UpdateRoutineExerciseInput, data map[string]interface{}) error
}
type UpdateWorkoutLogInputResolver interface {
	Sets(ctx context.Context, obj *ent.UpdateWorkoutLogInput, data map[string]interface{}) error
}
...
func (ec *executionContext) unmarshalInputCreateRoutineExerciseInput(ctx context.Context, obj interface{}) (ent.CreateRoutineExerciseInput, error) {
	var it ent.CreateRoutineExerciseInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"restTimer", "sets", "routinesID", "exercisesID", "usersID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "sets":
			...
			if err = ec.resolvers.CreateRoutineExerciseInput().Sets(ctx, &it, data); err != nil {
				return it, err
			}
		case "routinesID":
			var err error

			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("routinesID"))
		...
		case "exercisesID":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("exercisesID"))
			data, err := ec.unmarshalNID2string(ctx, v)
			if err != nil {
				return it, err
			}
...
func (ec *executionContext) unmarshalInputCreateWorkoutLogInput(ctx context.Context, obj interface{}) (ent.CreateWorkoutLogInput, error) {
	var it ent.CreateWorkoutLogInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"sets", "usersID", "exercisesID", "workoutsID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "sets":
			...
			if err = ec.resolvers.CreateWorkoutLogInput().Sets(ctx, &it, data); err != nil {
				return it, err
			}
		case "usersID":
			var err error
		...
		case "workoutsID":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("workoutsID"))
			data, err := ec.unmarshalOID2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
...
func (ec *executionContext) unmarshalInputRoutineExerciseWhereInput(ctx context.Context, obj interface{}) (ent.RoutineExerciseWhereInput, error) {
	...
	fieldsInOrder := [...]string{"not", "and", "or", "id", "idNEQ", "idIn", "idNotIn", "idGT", "idGTE", "idLT", "idLTE", "idEqualFold", "idContainsFold", "restTimer", "restTimerNEQ", "restTimerIn", "restTimerNotIn", "restTimerGT", "restTimerGTE", "restTimerLT", "restTimerLTE", "restTimerIsNil", "restTimerNotNil"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateRoutineExerciseInput(ctx context.Context, obj interface{}) (ent.UpdateRoutineExerciseInput, error) {
	var it ent.UpdateRoutineExerciseInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"restTimer", "clearRestTimer", "sets", "routinesID", "exercisesID", "usersID", "clearUsers"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "clearRestTimer":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("clearRestTimer"))
			data, err := ec.unmarshalOBoolean2bool(ctx, v)
			if err != nil {
				return it, err
			}
			it.ClearRestTimer = data
		case "sets":
			var err error
			...
			if err = ec.resolvers.UpdateRoutineExerciseInput().Sets(ctx, &it, data); err != nil {
				return it, err
			}
		case "routinesID":
			var err error
...
func (ec *executionContext) unmarshalInputUpdateWorkoutLogInput(ctx context.Context, obj interface{}) (ent.UpdateWorkoutLogInput, error) {
	var it ent.UpdateWorkoutLogInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"sets", "usersID", "clearUsers", "exercisesID", "clearExercises", "workoutsID", "clearWorkouts"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "sets":
			...
			if err = ec.resolvers.UpdateWorkoutLogInput().Sets(ctx, &it, data); err != nil {
				return it, err
			}
		case "usersID":
			var err error
