...
CREATE TABLE `new_workouts` (`id` text NOT NULL, `volume` integer NOT NULL, `duration` text NOT NULL, `sets` integer NOT NULL, `created_at` text NOT NULL, `image` json NULL, `description` text NULL, `user_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `workouts_users_workouts` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE);
