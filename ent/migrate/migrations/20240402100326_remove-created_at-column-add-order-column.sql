...
INSERT INTO `new_routine_exercises` (`id`, `rest_time`, `sets`, `routine_id`, `exercise_id`, `user_id`) SELECT `id`, `rest_time`, `sets`, `routine_id`, `exercise_id`, `user_id` FROM `routine_exercises`;
