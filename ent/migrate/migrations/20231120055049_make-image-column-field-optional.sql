...
CREATE TABLE `new_muscles_groups` (`id` text NOT NULL, `name` text NOT NULL, `image` json NULL, PRIMARY KEY (`id`));
...
CREATE TABLE `new_equipment` (`id` text NOT NULL, `name` text NOT NULL, `image` json NULL, PRIMARY KEY (`id`));
...
CREATE TABLE `new_exercises` (`id` text NOT NULL, `name` text NOT NULL, `image` json NULL, `how_to` text NULL, `user_id` text NULL, PRIMARY KEY (`id`), CONSTRAINT `exercises_users_exercises` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE);
