...
type RoutineExerciseWhereInput struct {
	...
	RoutineIDIsNil        bool     `json:"routineIDIsNil,omitempty"`
	RoutineIDNotNil       bool     `json:"routineIDNotNil,omitempty"`
...
func (i *RoutineExerciseWhereInput) P() (predicate.RoutineExercise, error) {
	...
	if i.RoutineIDIsNil {
		predicates = append(predicates, routineexercise.RoutineIDIsNil())
	}
	if i.RoutineIDNotNil {
		predicates = append(predicates, routineexercise.RoutineIDNotNil())
	}
	...
	if i.ExerciseIDIsNil {
		predicates = append(predicates, routineexercise.ExerciseIDIsNil())
	}
	if i.ExerciseIDNotNil {
		predicates = append(predicates, routineexercise.ExerciseIDNotNil())
	}
