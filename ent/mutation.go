...
type ExerciseMutation struct {
	...
	users                    *pksuid.ID
	clearedusers             bool
	equipment                map[pksuid.ID]struct{}
	removedequipment         map[pksuid.ID]struct{}
	...
	exercise_types           map[pksuid.ID]struct{}
	removedexercise_types    map[pksuid.ID]struct{}
...
func (m *ExerciseMutation) AddEquipmentIDs(ids ...pksuid.ID) {
	if m.equipment == nil {
		m.equipment = make(map[pksuid.ID]struct{})
	}
	for i := range ids {
...
func (m *ExerciseMutation) RemovedEquipmentIDs() (ids []pksuid.ID) {
...
func (m *ExerciseMutation) EquipmentIDs() (ids []pksuid.ID) {
...
func (m *ExerciseMutation) ResetEquipment() {
	m.equipment = nil
...
func (m *ExerciseMutation) AddExerciseTypeIDs(ids ...pksuid.ID) {
	if m.exercise_types == nil {
		m.exercise_types = make(map[pksuid.ID]struct{})
	}
	for i := range ids {
		m.exercise_types[ids[i]] = struct{}{}
	}
}
...
// RemoveExerciseTypeIDs removes the "exercise_types" edge to the ExerciseType entity by IDs.
func (m *ExerciseMutation) RemoveExerciseTypeIDs(ids ...pksuid.ID) {
	if m.removedexercise_types == nil {
		m.removedexercise_types = make(map[pksuid.ID]struct{})
	}
	for i := range ids {
		delete(m.exercise_types, ids[i])
		m.removedexercise_types[ids[i]] = struct{}{}
	}
}

// RemovedExerciseTypes returns the removed IDs of the "exercise_types" edge to the ExerciseType entity.
func (m *ExerciseMutation) RemovedExerciseTypesIDs() (ids []pksuid.ID) {
	for id := range m.removedexercise_types {
		ids = append(ids, id)
	}
	return
}
...
func (m *ExerciseMutation) AddWorkoutIDs(ids ...pksuid.ID) {
	if m.workouts == nil {
...
func (m *ExerciseMutation) RemoveWorkoutIDs(ids ...pksuid.ID) {
...
func (m *ExerciseMutation) RemovedWorkoutsIDs() (ids []pksuid.ID) {
...
func (m *ExerciseMutation) WorkoutsIDs() (ids []pksuid.ID) {
...
func (m *ExerciseMutation) AddedEdges() []string {
	...
	if m.equipment != nil {
		edges = append(edges, exercise.EdgeEquipment)
	}
	if m.muscles_groups != nil {
...
func (m *ExerciseMutation) AddedIDs(name string) []ent.Value {
	...
	case exercise.EdgeExerciseTypes:
		ids := make([]ent.Value, 0, len(m.exercise_types))
		for id := range m.exercise_types {
			ids = append(ids, id)
		}
		return ids
...
func (m *ExerciseMutation) RemovedIDs(name string) []ent.Value {
	...
	case exercise.EdgeMusclesGroups:
		...
		return ids
	case exercise.EdgeExerciseTypes:
		ids := make([]ent.Value, 0, len(m.removedexercise_types))
		for id := range m.removedexercise_types {
			ids = append(ids, id)
		}
		return ids
...
func (m *RoutineExerciseMutation) SetSets(s []*schematype.Set) {
	m.sets = &s
	m.appendsets = nil
}

// Sets returns the value of the "sets" field in the mutation.
func (m *RoutineExerciseMutation) Sets() (r []*schematype.Set, exists bool) {
	v := m.sets
	if v == nil {
		return
	}
...
// If the RoutineExercise object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoutineExerciseMutation) OldSets(ctx context.Context) (v []*schematype.Set, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// AppendSets adds s to the "sets" field.
func (m *RoutineExerciseMutation) AppendSets(s []*schematype.Set) {
	m.appendsets = append(m.appendsets, s...)
}

// AppendedSets returns the list of values that were appended to the "sets" field in this mutation.
func (m *RoutineExerciseMutation) AppendedSets() ([]*schematype.Set, bool) {
	if len(m.appendsets) == 0 {
		return nil, false
	}
	return m.appendsets, true
}
...
func (m *WorkoutMutation) SetDuration(s string) {
	m.duration = &s
}

// Duration returns the value of the "duration" field in the mutation.
func (m *WorkoutMutation) Duration() (r string, exists bool) {
	v := m.duration
	if v == nil {
		return
	}
...
// OldDuration returns the old "duration" field's value of the Workout entity.
// If the Workout object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WorkoutMutation) OldDuration(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *WorkoutMutation) ResetDuration() {
	m.duration = nil
}
...
// SetImage sets the "image" field.
func (m *WorkoutMutation) SetImage(s *schematype.Image) {
	m.image = &s
}

// Image returns the value of the "image" field in the mutation.
func (m *WorkoutMutation) Image() (r *schematype.Image, exists bool) {
	v := m.image
	if v == nil {
		return
	}
...
// If the Workout object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WorkoutMutation) OldImage(ctx context.Context) (v *schematype.Image, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldImage is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *WorkoutMutation) ClearDescription() {
	m.description = nil
	m.clearedFields[workout.FieldDescription] = struct{}{}
}

// DescriptionCleared returns if the "description" field was cleared in this mutation.
func (m *WorkoutMutation) DescriptionCleared() bool {
	_, ok := m.clearedFields[workout.FieldDescription]
	return ok
}
...
func (m *WorkoutMutation) ResetDescription() {
	m.description = nil
	delete(m.clearedFields, workout.FieldDescription)
}
...
// AddExerciseIDs adds the "exercises" edge to the Exercise entity by ids.
func (m *WorkoutMutation) AddExerciseIDs(ids ...pksuid.ID) {
	if m.exercises == nil {
		m.exercises = make(map[pksuid.ID]struct{})
	}
	for i := range ids {
...
// RemoveExerciseIDs removes the "exercises" edge to the Exercise entity by IDs.
func (m *WorkoutMutation) RemoveExerciseIDs(ids ...pksuid.ID) {
	if m.removedexercises == nil {
		m.removedexercises = make(map[pksuid.ID]struct{})
	}
	for i := range ids {
...
// RemovedExercises returns the removed IDs of the "exercises" edge to the Exercise entity.
func (m *WorkoutMutation) RemovedExercisesIDs() (ids []pksuid.ID) {
	for id := range m.removedexercises {
		ids = append(ids, id)
	}
	return
...
// ExercisesIDs returns the "exercises" edge IDs in the mutation.
func (m *WorkoutMutation) ExercisesIDs() (ids []pksuid.ID) {
	for id := range m.exercises {
		ids = append(ids, id)
	}
	return
...
func (m *WorkoutMutation) ClearedFields() []string {
	...
	if m.FieldCleared(workout.FieldDescription) {
		fields = append(fields, workout.FieldDescription)
	}
	return fields
}
...
// SetSets sets the "sets" field.
func (m *WorkoutLogMutation) SetSets(s []*schematype.Set) {
	m.sets = &s
	m.appendsets = nil
}

// Sets returns the value of the "sets" field in the mutation.
func (m *WorkoutLogMutation) Sets() (r []*schematype.Set, exists bool) {
	v := m.sets
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WorkoutLogMutation) OldSets(ctx context.Context) (v []*schematype.Set, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSets is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AppendSets adds s to the "sets" field.
func (m *WorkoutLogMutation) AppendSets(s []*schematype.Set) {
	m.appendsets = append(m.appendsets, s...)
}

// AppendedSets returns the list of values that were appended to the "sets" field in this mutation.
func (m *WorkoutLogMutation) AppendedSets() ([]*schematype.Set, bool) {
	if len(m.appendsets) == 0 {
		return nil, false
	}
	return m.appendsets, true
